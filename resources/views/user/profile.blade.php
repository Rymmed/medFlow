                    ...
                    <div class="col-lg-6 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a id="security-tab" class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab"
        ...
        <div class="container-fluid py-4">
            ...
            @if(auth()->user()->role === 'doctor')
                <div class="card" id="availability-form" style="display: none;">
                    ...
                    <div class="card-body pt-4 p-3">
                        <form action="{{ route('availability.update', ['availability'=>auth()->user()->id]) }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="start_time"
                                               class="form-control-label">{{ __('Heure d\'ouverture') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="end_time"
                                               class="form-control-label">{{ __('Heure de fermeture') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="days_of_week"
                                               class="form-control-label">{{ __('Jours de travail') }}</label>
                                        <div class="@error('days_of_week') border border-danger rounded-3 @enderror">
                                            <select class="form-control" id="days_of_week" name="days_of_week[]"
                                                ...
                                                @foreach(['Dimanche', 'Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'] as $index => $day)
                                                    <option
                                                        value="{{ $index }}" {{ $availability->days_of_week && in_array($index, json_decode($availability->days_of_week)) ? 'selected' : '' }}>{{ $day }}</option>
                                                @endforeach
                                            </select>
                                            @error('days_of_week')
                                            <p class="text-danger text-xs mt-2">{{ $message }}</p>
