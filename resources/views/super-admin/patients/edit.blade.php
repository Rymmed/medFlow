                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('user.lastName')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ $patient->lastName }}" type="text"
                                       placeholder="{{ __('Entrez le nom') }}" id="lastName" name="lastName">
                                @error('lastName')
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('user.firstName')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ $patient->firstName }}" type="text"
                                       placeholder="{{ __('Entrez le prénom') }}" id="firstName" name="firstName">
                                @error('firstName')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('email')border border-danger rounded-3 @enderror">
                                <input class="form-control" value="{{ $patient->email }}" type="email"
                                       placeholder="{{ __('Entrez l\'adresse email') }}" id="email" name="email">
                                @error('email')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" name="gender" id="male"
                                ...
                                {{ $patient->gender == \App\Enums\Gender::MALE ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-3">
                            <input type="radio" class="form-check-input" name="gender" id="female"
                                ...
                                {{ $patient->gender == \App\Enums\Gender::FEMALE ? 'checked' : '' }}>
                            <label class="custom-control-label"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="@error('user.phone_number')border border-danger rounded-3 @enderror">
                                <input class="form-control" type="text" value="{{ $patient->phone_number }}"
                                       placeholder="{{ __('Entrez le numéro de téléphone') }}" id="phone_number"
                                       name="phone_number">
                                @error('phone_number')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
